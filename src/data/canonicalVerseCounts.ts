// Canonical verse counts per chapter for all 66 books of the Bible
// Generated from verified canonical biblical data
export const CANONICAL_VERSE_COUNTS: Record<number, number[]> = {
  ...
  16: [11, 20, 32, 23, 19, 19, 74, 18, 38, 39, 36, 47, 31],
  ...
  19: [6, 12, 8, 8, 12, 10, 17, 9, 20, 18, 7, 8, 6, 7, 5, 11, 15, 50, 14, 9, 13, 31, 6, 10, 22, 12, 14, 9, 11, 12, 24, 11, 22, 22, 28, 12, 40, 22, 13, 17, 13, 11, 5, 26, 17, 11, 10, 14, 20, 23, 19, 9, 6, 7, 23, 13, 12, 11, 17, 12, 8, 12, 11, 10, 13, 20, 7, 35, 36, 5, 24, 20, 28, 23, 10, 12, 20, 72, 13, 19, 16, 8, 18, 12, 13, 17, 7, 18, 52, 17, 16, 15, 5, 23, 11, 13, 12, 9, 9, 5, 8, 28, 22, 35, 45, 48, 43, 13, 31, 7, 10, 10, 9, 8, 18, 19, 2, 29, 176, 7, 8, 9, 4, 8, 5, 6, 5, 6, 8, 8, 3, 18, 3, 3, 21, 26, 9, 8, 24, 13, 10, 7, 12, 15, 21, 10, 20, 14, 9, 6],
  ...
  42: [80, 52, 38, 44, 39, 49, 50, 56, 63, 42, 54, 59, 35, 35, 32, 31, 37, 43, 48, 47, 38, 71, 56, 53],
  43: [51, 25, 36, 54, 47, 71, 53, 59, 41, 42, 57, 51, 38, 31, 27, 34, 26, 40, 42, 31, 25],
...
export function getCanonicalVerseCount(bookNumber: number, chapter: number): number {
  const chapters = CANONICAL_VERSE_COUNTS[bookNumber];
  if (!chapters || chapter < 1 || chapter > chapters.length) return 25;
  return chapters[chapter - 1] || 25;
}
