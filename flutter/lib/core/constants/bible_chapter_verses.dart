...
const Map<int, List<int>> kCanonicalVerseCounts = {
...
int getCanonicalVerseCount(int bookNumber, int chapter) {
  final chapters = kCanonicalVerseCounts[bookNumber];
  if (chapters == null || chapter < 1 || chapter > chapters.length) return 25;
